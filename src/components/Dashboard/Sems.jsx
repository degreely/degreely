        ...
        <>
            {Object.values(sems).map((sem, index) => {
                ...
                return (
                    <Row className={`sems-row${inEditMode ? "-edit" : ""}`} key={index}>
                        <Col>
                            <Sem inEditMode={inEditMode} semData={sem} handleModRightClick={handleModRightClick} modColor={`gradient-color-${modColor}`}/>
                        </Col>
                    </Row>
                );
            })}
                ...
                <Col>
                    <Row className={`sems-row${inEditMode ? "-edit" : ""}`}>
                        <Col style={{display: "flex", flexDirection: "row-reverse"}}>
                            <AppsIcon fontSize="large" onClick={handleListView} style={{color: "gray", cursor: "pointer"}} />
                            <ViewAgendaIcon fontSize="large" onClick={handleGridView} style={{color: "gray", cursor: "pointer"}} />
                        </Col>
                    </Row>
                    {isListView
                        ? <SemsList
